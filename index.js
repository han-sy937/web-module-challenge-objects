...
console.log(createMenuItem('Apple Pie', 8, 'Dessert'));
console.log(createMenuItem('Spaghetti', 17, 'Italian'));
console.log(createMenuItem('Baked', 3, 'Sides'));
...
reviews.push({name: "Janet", rating: 4, feedback: "The food was amazing. The service could be better. Will definitely return for more"})
